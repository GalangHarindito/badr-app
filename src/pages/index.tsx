...
if(isDeleting){
  return <p className='text-xl flex items-center justify-center font-bold'>lagi loading delete....</p>
}
  return (
    <>
    {data && <OrderManagement data={data} onDelete={(id:string|number) => handleDelete(id)} />}
    </>
